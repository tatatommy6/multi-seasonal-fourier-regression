...
- Tester : 함태준(rrayy-25809), 김민결(tatatommy6)
...
- [make_plot_by_prophet.py](https://github.com/tatatommy6/multi-seasonal-fourier-regression/blob/main/benchmark/Prophet%20Compare%20Test/make_plot_by_porphet.py)는 [make_plot_by_msfr.py](https://github.com/tatatommy6/multi-seasonal-fourier-regression/blob/main/benchmark/make_plot_by_msfr.py)와 구조를 최대한 비슷하게 만들었음.
